    ...
    switch(parseInt($super)) {
        ...
        function menuLogout(){
            ...
            <div class="col-md-3 remove-links text-end">
                <button type="button" onclick="window.location.href='/pages/login.html';" class="btn btn-outline-primary mx-3 mt-1">
                    Ingresar
                </button>
                <button type="button" onclick="window.location.href='/pages/registration.html';" class="btn btn-primary  mx-1 mt-1">
                    Registrarse
                </button>
            </div>`;
        ...
        function menuCandidato(){
            ...
            <ul class="nav col-12 col-md-auto remove-links mb-2 justify-content-center mb-md-0">
                <li>
                    <button type="button" onclick="window.location.href='/pages/enrolamiento.html';" class="btn btn-primary pd-2 mt-1 mx-3">
                        Sumate
                    </button>
        ...
        function menuRecruiter(){
            ...
            <ul class="nav col-12 col-md-auto remove-links mb-2 justify-content-center mb-md-0">
                ...
                <li>
                    <button type="button" onclick="window.location.href='/pages/busqueda.html';" class="btn btn-primary pd-2 mt-1 mx-1">
                        Busquedas
                    </button>    
                </li>
                <li>      
